...
/**
 * Order Costing Tab Component - IMPROVED
 * Shows detailed cost breakdown with hover tooltips for formulas
 * Professional color scheme and clean layout
 */

import React from 'react';
import { Calculator, TrendingUp, DollarSign, Package, Truck } from 'lucide-react';
