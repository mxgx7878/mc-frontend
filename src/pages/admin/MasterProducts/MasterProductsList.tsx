...
const MasterProductsList = () => {
  ...
  const { data: productTypesData } = useQuery<{ product_type: string }[]>({
    queryKey: ['product-types'],
    queryFn: () => masterProductsAPI.getProductTypes(),
  });
  ...
  const hasActiveFilters = searchQuery || filters.product_type || filters.is_approved !== undefined;
